...
export default function ReservationForm() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post("http://localhost:3000/rental/rentals", data)
    ...
    return (
        <div className="reservation-page">
            <div className="container py-5">
                <div className="reservation-box row p-4">
                    <div className="col-md-6">
                        <div className="text-gold mb-3 glow">
                            <h1 >
                            Reserve Your Car
                            <FaRegCalendarCheck className=" me-2 " style={{marginTop:"-15px" , marginLeft:"10px"}} />
                        </h1>
                        </div>

                        <p className="text-muted">Choose your car and set the rental dates</p>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className="btn btn-gold text-white w-100 mt-3" style={{ backgroundColor: "#000" }}>
                                Confirm Reservation
                            </button>
                        </form>
                    </div>
                    ...
                    <div className="col-md-6 d-flex align-items-center justify-content-center">
                        <img
                            src="/car-reservation.png"
                            alt="Reserve car"
                            className="img-fluid glow-img"
